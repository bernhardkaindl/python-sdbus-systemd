...
class SystemdInterface(
    ...
    def get_unit_by_invocation_i_d(
        self,
        invocation_id: bytes,
    ) -> str:
        raise NotImplementedError
    ...
    def list_unit_files_by_patterns(
        self,
        states: List[str],
        patterns: List[str],
    ) -> List[Tuple[str, str]]:
    ...
    def enable_unit_files_with_flags(
        self,
        files: List[str],
        flags: int,
    ) -> Tuple[bool, List[Tuple[str, str, str]]]:
    ...
    def disable_unit_files_with_flags(
        self,
        files: List[str],
        flags: int,
    ) -> List[Tuple[str, str, str]]:
    ...
    def preset_unit_files_with_mode(
        self,
        files: List[str],
        mode: str,
        runtime: bool,
    ...
    def lookup_dynamic_user_by_name(
        self,
        name: str,
    ) -> int:
        raise NotImplementedError
    ...
    def lookup_dynamic_user_by_u_i_d(
        self,
        uid: int,
    ) -> str:
        raise NotImplementedError
